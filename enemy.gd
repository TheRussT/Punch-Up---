...
var f_Table = [[125,108] , [6,-1,2,0,16,-2,-3,4,7,0,1,4,2,1,1,5,16,2,-2,4,7,0,1,4,2] , [50,17] , [3,0,0,15,2,2,-2,15,3,2,-2,15,3] , [3,3,-2,16,3,2,-2,16,3,4,-4,16,10], #Stats, Idle, Daze, Hit, Sent
...
var repeater = 0;
var hits_aval = 7;
var gaurd = [2,2,2,2] #left up, right up, left down, right down
